(function (global, factory) {
    ...
    'use strict';
    let SlideVerify = function (ele, opt) {
        this.$ele = $(ele);
        this.defaults = {
            initText: 'Slide To Confirm',
            successText: 'Success',
    ...
    SlideVerify.prototype = {
        ...
        initDom: function () {
            let html = $('<div class="drag-progress dragProgress"></div><span class="drag-btn dragBtn"></span><span class="fix-tips fixTips">'
                + this.settings.initText + '</span><span class="verify-msg sucMsg">' + this.settings.successText + '</span>');
        ...
        _touchmove: function () {
            ...
            _this.slideBtn.on('touchmove', function (e) {
                e.preventDefault();
                let curX = e.originalEvent.targetTouches[0].pageX - _this.touchX;
                if (curX >= _this.maxSlideWid) {
                    _this.setDragBtnSty(_this.maxSlideWid);
                    _this.setDragProgressSty(_this.maxSlideWid);
        ...
        ifSlideRight: function () {
            let _this = this;
            return _this.getDragBtnLeft() === _this.calSlideWidth();
        },
